...
export default function RideManagement() {
    ...
    const handleUpdate = async (e: React.FormEvent) => {
        ...
        try {
            ...
            // Use custom ID for update
            await axios.put(`${API_URL}/api/products/${editingRide.id}`, formData, {
            ...
            <main className="container mx-auto p-4 md:p-6 max-w-7xl">
                ...
                {loading ? (
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                        {rides.map(ride => (
                            <div key={ride.id} className="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden hover:shadow-md transition-shadow flex flex-col">
